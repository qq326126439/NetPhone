package com.lx.net.widget.recyclerview.decoration;
...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
    ...
    public RecyclerViewDivider(@NonNull Context context, int orientation) {
        ...
        mDividerHeight = context.getResources().getDimensionPixelOffset(R.dimen.dp_0_5);
     ...
     * @param parent 父容器
     */
    private void drawHorizontal(Canvas canvas, @NonNull RecyclerView parent) {
...
//            Log.e("height", height + "===================");
     ...
     * @param parent
     */
    private void drawVertical(Canvas canvas, @NonNull RecyclerView parent) {
